...
- Use `ToastProvider`/`useToast` for brief global feedback such as API failures or completed actions; keep toast messages short and use `alert`, `warning`, `success`, or `info` modes.
