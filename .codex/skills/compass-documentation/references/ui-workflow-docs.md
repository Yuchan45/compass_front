...
Use this when screens, components, navigation, design constants, assets, or user flows change.
...
- Describing every component prop unless it is part of a reusable public pattern.
- Screenshots or diagrams that will become stale quickly.
- Debug-only details in user-facing docs.
